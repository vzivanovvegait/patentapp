...
class StringUtils {
    ...
    class func createString(from wordArray: [Word]) -> String {
        let newStr = wordArray.filter { !$0.isSpecial }.map { $0.mainString }.joined(separator: " ").replacingOccurrences(of: " ,", with: ",", options: NSString.CompareOptions.literal, range: nil).replacingOccurrences(of: " .", with: ".", options: NSString.CompareOptions.literal, range: nil)
